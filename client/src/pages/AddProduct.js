...
export default function AddProduct() {
  const [form, setForm] = useState({
    name: "", actualPrice: "", discountPrice: "", category: "", stock: "", description: "", brand: ""
  });
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={submit} style={{ display: "grid", gap: 10, maxWidth: 560 }}>
        ...
        <input type="number" placeholder="Actual Price" value={form.actualPrice}
          onChange={(e) => setForm({ ...form, actualPrice: e.target.value })} required />

        <input type="number" placeholder="Discount Price" value={form.discountPrice}
          onChange={(e) => setForm({ ...form, discountPrice: e.target.value })} required />
